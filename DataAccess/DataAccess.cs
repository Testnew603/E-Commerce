...
namespace ECommerceAPI.DataAccess
{
    public class DataAccess : IDataAccess
    {
        ...
        public DataAccess(IConfiguration configuration)
        {
            ...
            _dbconnection = this._configuration["ConnectionStrings:DefaultConnection"];
            _dateformat = this._configuration["Constants:DateFormat"];
        }
        ...
        public string IsUserPresent(string email, string password)
        {
            ...
            using (SqlConnection connection = new(_dbconnection))
            {
                ...
                string key = "MNU66iBl3T5rh6H52i69projECOMMERCE98765";
                string duration = "60";
        ...
        public int InsertPayment(Payment payment)
        {
            using (SqlConnection connection = new(_dbconnection))
            {
                ...
                command.Parameters.Add("@sc", System.Data.SqlDbType.NVarChar).Value = payment.ShippingCharge;
        ...
        public int InsertOrder(Order order)
        {
            ...
            {             
                ...
                if(value > 0)
                {
                    query = "UPDATE Carts SET Ordered='true', OrderedOn='" + DateTime.Now.ToString(_dateformat) + "' WHERE CartId=" + order.Cart.Id + ";";
                    command.CommandText = query;
                    command.ExecuteNonQuery();
